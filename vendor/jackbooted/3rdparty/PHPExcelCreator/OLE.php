...
class OLE {
    ...
    function _readPpsWks( $pps_wk_start, $big_block_size ) {
        ...
        while ( 1 ) {
            ...
            if ( ($type[''] != OLE_PPS_TYPE_ROOT) and ( $type[''] != OLE_PPS_TYPE_DIR) and ( $type[''] != OLE_PPS_TYPE_FILE) ) {
            ...
            $this->_list[] = new OLE_PPS( null, '', $type[''], $prev[''], $next[''], $dir[''], OLE::OLE2LocalDate( $time_1st ), OLE::OLE2LocalDate( $time_2nd ), ($start_block[''] + 1) * $big_block_size, array() );
            // give it a size
